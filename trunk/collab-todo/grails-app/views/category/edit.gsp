                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:category,field:'name','errors')}">
                                    <input type="text" id="name" name="name" value="${fieldValue(bean:category,field:'name')}"/>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:category,field:'description','errors')}">
                                    <input type="text" id="description" name="description" value="${fieldValue(bean:category,field:'description')}"/>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:category,field:'todos','errors')}">
...
<g:link controller="todo" params="['category.id':category?.id]" action="create">Add Todo</g:link>
                            ...
                            <!-- tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:category,field:'user','errors')}">
                                    <g:select optionKey="id" from="${User.list()}" name="user.id" value="${category?.user?.id}" ></g:select>
                                </td>
                            </tr --> 
