package com.nestorurquiza.ws.axis2.service;

public class DynamicServiceSample {
  static private final long serialVersionUID = 2L;

  public Person getPerson( String userName ) {
    Person person = new Person();
    person.setFirstName(getFirstName(userName));
    person.setLastName(getLastName(userName));
    Address address = new Address();
    address.setCountry("USA");
    address.setZip("44167");
