 ...
 * 
 */
@WebServiceClient(name = "ExchangeService", targetNamespace = "http://schemas.microsoft.com/exchange/services/2006/messages", wsdlLocation = "file:/Users/nestor/Downloads/Services2.wsdl")
public class ExchangeService
    extends Service
{

    private final static URL EXCHANGESERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.nestorurquiza.ews.jaxws.ExchangeService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.nestorurquiza.ews.jaxws.ExchangeService.class.getResource(".");
            url = new URL(baseUrl, "file:/Users/nestor/Downloads/Services.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/Users/nestor/Downloads/Services.wsdl', retrying as a local file");
